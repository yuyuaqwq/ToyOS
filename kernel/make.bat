...
ld -Ttext 0xc0001500 -e main -o ..\build\kernel.bin -mi386pe ..\build\main.o ..\build\init.o ..\build\interrupt.o ..\build\kernel.o ..\build\debug.o ..\build\bitmap.o ..\build\memory.o ..\build\thread.o ..\build\switch.o ..\build\string.o ..\build\timer.o ..\build\print.o ..\build\list.o
