...
#define IDT_DESC_ATTR_DPL0 (IDT_DESC_ATTR_DPL0 | IDT_DESC_P | IDT_DESC_DPL0 | IDT_DESC_32_TYPE)
#define IDT_DESC_ATTR_DPL3 (IDT_DESC_ATTR_DPL3 | IDT_DESC_P | IDT_DESC_DPL3 | IDT_DESC_32_TYPE)
